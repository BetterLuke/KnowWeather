package com.example.luke.knowweather.model;
...
import com.example.luke.knowweather.db.KnowWeatherOpenHelper;
...
public class KnowWeatherDB {
    ...
    /**
     * 将构造方法私有化，外部不能通过new来获取实例
     * @param context
     */
    private KnowWeatherDB(Context context) {
        KnowWeatherOpenHelper dbHelper = new KnowWeatherOpenHelper(context,DB_NAME,null,version);
